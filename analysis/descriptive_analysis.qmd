...
ggsave(
  here::here("analysis/figures/heatmap_ggplot.jpeg"),
  width = 8,
  height = 6,
  dpi = 300
)

# faceted bar chart for each stage
# IN PROGRESS
research_stage_long |> 
  ggplot(aes(x = emotion, y = mean_value)) +
  geom_bar(stat = "identity") +
  facet_wrap(~ research_stage) +
  scale_y_continuous(limits = c(0, 7), expand = c(0, 0)) +
  theme_minimal() +
  labs(title = "Emotion intensity by research stage", y = "", x = "") +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1),
